    ...
    <div class="flex flex-col">
      <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="py-2 mr-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
          <a href="tambah.php">
            <button type="button" class="mb-3 mr-1 py-2 px-4 font-semibold rounded-lg shadow-md text-white text-sm bg-indigo-500 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              Add product
            </button>
          </a>
          <a href="logout.php" class="ml-auto">
            <button type="button" class="mb-3 py-2 px-4 font-semibold rounded-lg shadow-md text-white text-sm bg-gray-500 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
              Logout
            </button>
          </a>
