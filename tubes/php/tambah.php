    ...
    <div class="container">
        <div class="box">
            <div class="row contentForm">
                ...
                <div class="col-sm-12 col-md-6 col lg-6">
                    <h3 class="text-center mb-5">Tambah Daftar Buku</h3>
